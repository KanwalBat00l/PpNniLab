...
=======
    ...
    // Resolve absolute path to PPNNI.Mock
    ...
    require(scriptFile.exists()) {
        "Script not found: ${scriptFile.absolutePath}"
    }
    ...
    // Copy ALL environment variables (VERY IMPORTANT)
    pb.environment().clear()
    pb.environment().putAll(System.getenv())

    pb.directory(modelDir)  // ensures pretrained/model paths resolve properly
